...
Item {
    ...
    function accentFor(id) {
        return ({
                ...
                visibility: root.themeTextColor,
                moonphase: root.accentViolet,
                condition: root.themeTextColor,
    ...
    function iconColorFor(c) {
        return (root.iconTheme === "symbolic") ? root.themeTextColor : c;
    }
                    ...
                    Repeater {
                        ...
                        delegate: Rectangle {
                            ...
                            Rectangle {
                                ...
                                height: 1
                                color: Qt.rgba(root.themeTextColor.r, root.themeTextColor.g, root.themeTextColor.b, 0.10)
                            }
                            ...
                            Loader {
                                anchors.fill: parent
                                active: card.modelData === "wind" && !root.isList
                                sourceComponent: Item {
                                        ...
                                        Column {
                                            ...
                                            Canvas {
                                                ...
                                                readonly property color _textCol: root.themeTextColor
                            ...
                            Loader {
                                anchors.fill: parent
                                active: card.modelData === "pressure" && !root.isList
                                sourceComponent: Item {
                                        id: pressureCard
                                        anchors.fill: parent
                                        clip: true
                            ...
                            Loader {
                                anchors.fill: parent
                                active: card.modelData === "airquality"
                                sourceComponent: Item {
                                        id: aqiCard
                                        anchors.fill: parent
                                        clip: true
                                                            ...
                                                            ColumnLayout {
                                                                ...
                                                                Item {
                                                                    ...
                                                                    Rectangle {
                                                                        ...
                                                                        radius: 11
                                                                        color: band ? band.color : "#4CAF50"
                                                                        border.color: root.themeTextColor
                                                                        border.width: 1
                                                                        visible: !isNaN(modelData.si)
                            ...
                            Loader {
                                anchors.fill: parent
                                active: card.modelData === "spaceweather"
                                sourceComponent: Item {
                                        id: swCard
                                        anchors.fill: parent
                                        clip: true
                            ...
                            Loader {
                                anchors.fill: parent
                                active: card.modelData === "alerts" && weatherRoot && weatherRoot.weatherAlerts && weatherRoot.weatherAlerts.length > 0
                                sourceComponent: Item {
                                        id: alertsCard
                                        anchors.fill: parent
                                        clip: true
                                        ...
                                        RowLayout {
                                            ...
                                            Label {
                                                ...
                                                color: alertsCard.alerts.length > 0 ? alertsCard.alertColorText(alertsCard.alerts[0].color) : root.themeTextColor
                                                font: weatherRoot ? weatherRoot.wf(11, true) : Qt.font({
                                                    bold: true
                                                })
                                                elide: Text.ElideRight
                                        ...
                                        RowLayout {
                                            ...
                                            Label {
                                                ...
                                                color: {
                                                    var a = alertsCard.todayAlerts[alertsCard.safeIndex];
                                                    return a ? alertsCard.alertColorText(a.color) : root.themeTextColor;
                                                }
                                                font: weatherRoot ? weatherRoot.wf(11, true) : Qt.font({
                                                    bold: true
                                                })
                            ...
                            Loader {
                                anchors.fill: parent
                                active: card.modelData === "datetime" && !root.isList
                                sourceComponent: Item {
                                        id: datetimeCard
                                        anchors.fill: parent
                                        clip: true
                                                        ...
                                                        Repeater {
                                                            ...
                                                            delegate: Item {
                                                                ...
                                                                Rectangle {
                                                                    ...
                                                                    height: width
                                                                    radius: width / 2
                                                                    color: parent._isToday ? root.themeHighlightColor : "transparent"
                                                                ...
                                                                Label {
                                                                    ...
                                                                    color: parent._isToday ? root.themeHighlightedTextColor : root.themeTextColor
                            ...
                            Loader {
                                anchors.fill: parent
                                active: card.modelData === "suntimes" && !root.isList
                                sourceComponent: Item {
                                        id: suntimesCard
                                        anchors.fill: parent
                                        clip: true
                            ...
                            Loader {
                                anchors.fill: parent
                                active: card.modelData === "moonphase" && !root.isList
                                sourceComponent: Item {
                                        id: moonCard
                                        anchors.fill: parent
                                        clip: true
